window.CHANGELOG = [
  ...
  },
  {
    ...
    "items": [
      ...
      "· «Общение»: 65 глаголов → речь / просьбы и советы / справка",
      "· «Домашние дела»: 52 глагола → быт, ремонт, жильё, режим дня",
      "· «Абстрактное»: 60 существительных → 4 темы",
      "stehen / liegen / hängen / stellen / setzen собраны в одну тему «Положение в пространстве»",
      "Цвета и узоры разделены: kariert и gestreift больше не лежат среди цветов",
      "Удалено 4 дубля: Stunde, Beruf, Führerschein, Erlaubnis"
    ],
  ...
  },
  {
    ...
    "titleEn": "Minor fixes",
    "itemsEn": [
      "Lock the translation when flipping the card",
      "Fixed the automatic dark/light theme (it didn't always respect the system setting)",
      "Fixing signatures in the rules section"
    ]
  },
  {
    "date": "2026-08-04",
  ...
  },
  {
    ...
    "itemsEn": [
      ...
      "5 Phrases",
      "1 new rule",
      "Fixed: All parts of speech are now displayed in the \"Neu\" buffer"
    ]
  },
  {
    "date": "2026-06-03",
